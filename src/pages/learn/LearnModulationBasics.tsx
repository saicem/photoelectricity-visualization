...
export default function LearnModulationBasics() {
  const { currentIndex, totalChapters, prevChapter, nextChapter, IconPrev, IconNext } = useChapterNavigation(
    ROUTES.LEARN.MODULATION_BASICS,
  );
        ...
        <div className="space-y-4 text-lab-muted leading-relaxed">
          ...
          <div className="bg-lab-bg/50 p-5 rounded-xl">
            ...
            <div className="flex items-center justify-center gap-3 text-sm">
              ...
              <div className="text-center">
                <div className="px-3 py-2 bg-laser-purple/20 border border-laser-purple/40 rounded-lg text-laser-purple font-semibold">
                  调制器
                </div>
                <div className="text-xs text-lab-muted mt-1">&nbsp;</div>
              </div>
              <div className="text-laser-cyan text-xl">→</div>
              <div className="text-center">
            ...
            <div className="text-center mt-3">
              <div className="text-xs text-lab-muted">光载波 c(t) = A·cos(ω_c t + φ₀) → 调制器输入</div>
            </div>
          </div>
        ...
        <div className="space-y-4 text-lab-muted leading-relaxed">
          ...
          <div className="grid md:grid-cols-2 gap-6">
            ...
            <div>
              ...
              <p className="text-sm mb-2">单音调制时，AM 信号包含三个频率分量：</p>
              <ul className="text-xs space-y-1">
                <li>• 载波分量：f_c</li>
                <li>• 上边带：f_c + F</li>
                <li>• 下边带：f_c - F</li>
              </ul>
              <p className="text-xs text-lab-muted mt-2">带宽 B = 2F，其中 F 是调制信号的最高频率。</p>
            </div>
          </div>
        ...
        <div className="space-y-4 text-lab-muted leading-relaxed">
          ...
          <div className="grid md:grid-cols-2 gap-6">
            ...
            <div>
              ...
              <p className="text-sm mb-2">PM 信号的近似带宽（包含 98% 能量）：</p>
              <div className="bg-lab-bg/50 px-4 py-2 rounded-lg">
                <MathRenderer>{'$$B \\approx 2(m_p + 1)F$$'}</MathRenderer>
              </div>
              <p className="text-xs text-lab-muted mt-2">F 是调制信号的最高频率。带宽随调制指数增大而增加。</p>
            </div>
          </div>
        ...
        <div className="space-y-4 text-lab-muted leading-relaxed">
          ...
          <div className="grid md:grid-cols-2 gap-6">
            ...
            <div>
              ...
              <p className="text-sm mb-2">FM 信号的近似带宽：</p>
              <div className="bg-lab-bg/50 px-4 py-2 rounded-lg">
                <MathRenderer>{'$$B \\approx 2(\\Delta f_{max} + F) = 2(m_f + 1)F$$'}</MathRenderer>
              </div>
              <p className="text-xs text-lab-muted mt-2">宽带 FM（m_f ≫ 1）时，B ≈ 2Δf_max，带宽主要由频偏决定。</p>
            </div>
          </div>
        ...
        <div className="space-y-4 text-lab-muted leading-relaxed">
          ...
          <div className="grid md:grid-cols-2 gap-6">
            ...
            <div className="border border-laser-cyan/30 bg-laser-cyan/5 p-4 rounded-xl">
              ...
              <div className="bg-lab-bg/50 p-3 rounded-lg text-xs">
                <div className="font-medium text-lab-text mb-1">工作原理</div>
                <p className="text-lab-muted">CW 激光 → 外部调制器 → 已调光信号</p>
              </div>
              <div className="space-y-2 mt-3">
                <div>
                  <span className="text-lab-text text-sm font-medium">优点：</span>
        ...
        <div className="space-y-4 text-lab-muted leading-relaxed">
          ...
          <div className="grid md:grid-cols-2 gap-4">
            <div className="bg-lab-bg/50 p-4 rounded-xl">
              ...
              <p className="text-xs text-lab-muted mt-2">典型值：OOK ~1，QPSK ~2，16QAM ~4，64QAM ~6 bit/s/Hz</p>
            </div>
            ...
            <div className="bg-lab-bg/50 p-4 rounded-xl">
              ...
              <p className="text-sm mb-2">光通过调制器后的功率损失，包括耦合损耗、传播损耗等。</p>
              <div className="bg-lab-surface/50 px-3 py-2 rounded-lg text-xs font-mono">
                IL = 10·log₁₀(P_in / P_out)
              </div>
              <p className="text-xs text-lab-muted mt-2">典型值：3-6 dB。插入损耗越低，系统功率预算越充裕。</p>
            </div>
